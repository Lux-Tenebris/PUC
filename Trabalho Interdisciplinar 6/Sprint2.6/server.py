...
pytesseract.pytesseract.tesseract_cmd = '/usr/bin/tesseract'  # Altere o caminho para o executável do Tesseract OCR no seu sistema
tessdata_dir_config = '--tessdata-dir "/usr/share/tesseract-ocr/4.00/tessdata"'  # Altere o caminho para o diretório tessdata do Tesseract OCR no seu sistema
